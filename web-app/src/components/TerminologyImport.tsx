  ...
  return (
    <div className="space-y-6 text-slate-900">
      ...
      <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
        <h2 className="text-xl font-bold text-slate-800 mb-4">Import Terminology</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">Terminology Type</label>
            <select
              value={type}
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">File (Zip)</label>
            <input
              id="file-upload"
              type="file"
              accept=".zip,.txt"
      ...
      <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
        <h2 className="text-xl font-bold text-slate-800 mb-4">Import Jobs</h2>
