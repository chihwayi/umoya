  ...
  private getProvisioningBundles(): ProvisioningBundle[] {
    return [
      ...
      },
      {
        ...
        version: '2026.03.26.2',
        description: 'medication reconciliation reviews, substitution recommendations, inventory forecasts, and dispensing anomalies for AI-first pharmacy workflows',
