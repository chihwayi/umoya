...
const tenant_entity_alignment_statements_1 = require("../generated/tenant-entity-alignment.statements");
const tenant_entity_structure_alignment_statements_1 = require("../generated/tenant-entity-structure-alignment.statements");
const tenant_entity_shadow_cleanup_statements_1 = require("../generated/tenant-entity-shadow-cleanup.statements");
let DatabaseProvisioningService = DatabaseProvisioningService_1 = class DatabaseProvisioningService {
    ...
    getProvisioningBundles() {
        return [
            ...
            },
            {
                ...
                version: tenant_entity_alignment_statements_1.TENANT_ENTITY_ALIGNMENT_BUNDLE_VERSION,
                ...
                statements: () => tenant_entity_alignment_statements_1.TENANT_ENTITY_ALIGNMENT_STATEMENTS,
            },
            {
                id: 'tenant_entity_shadow_cleanup',
                label: 'Tenant Entity Shadow Cleanup',
                version: tenant_entity_shadow_cleanup_statements_1.TENANT_ENTITY_SHADOW_CLEANUP_BUNDLE_VERSION,
                description: 'Backfills canonical snake_case columns from legacy camelCase shadow columns and drops the shadows',
                statements: () => tenant_entity_shadow_cleanup_statements_1.TENANT_ENTITY_SHADOW_CLEANUP_STATEMENTS,
            },
            {
                id: 'tenant_entity_structure_alignment',
                label: 'Tenant Entity Structure Alignment',
                version: tenant_entity_structure_alignment_statements_1.TENANT_ENTITY_STRUCTURE_ALIGNMENT_BUNDLE_VERSION,
                description: 'Generated structural backfill bundle for entity-declared indexes, unique constraints, and foreign keys',
                statements: () => tenant_entity_structure_alignment_statements_1.TENANT_ENTITY_STRUCTURE_ALIGNMENT_STATEMENTS,
            },
        ];
    }
    ...
    getSprint111EncounterOrchestrationStatements() {
        return [
    ...
    getSprint112RegistrationIntelligenceStatements() {
        return [
    ...
    getSprint111PharmacyIntelligenceStatements() {
        return [
    ...
    getSprint111RadiologyIntelligenceStatements() {
        return [
    ...
    getSprint111PatientAiUnificationStatements() {
        return [
    ...
    getSprint111AiReleaseGateStatements() {
        return [
    ...
    getSprint111FinancialIntelligenceStatements() {
        return [
    ...
    getSprint111VitalsOperationalStatements() {
        return [
    ...
    getMaternityCareTaskSchemaStatements() {
        return [
    ...
    getSprint47NurseCrossModuleWorkflowSchemaStatements() {
        return [
...
{{recommendations}}`,
    ...
    getSprint14_2ClaimsEnhancementStatements() {
        const statements = [];
        statements.push(`
      DO $$ 
      BEGIN
    ...
    getSprint16WorkflowSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint17CarePlansSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint18ReferralManagementSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint19DocumentManagementSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint20ProviderMessagingSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint27AnesthesiaSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint28BCMASchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint29BloodBankSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint30InfectionControlSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint32CDISchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint33CaseManagementSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint34DietarySchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint35RespiratorySchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint36PhysicalTherapySchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint37SupplyChainSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint38SepsisSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint39AdvancedNursingSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint40PatientSafetySchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint41QualityReportingSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint42AdvancedAnalyticsSchemaStatements() {
        const statements = [];
        statements.push(`
    ...
    getSprint45DrugEnhancementSchemaStatements() {
        const statements = [];
    ...
    getSprint45PharmacyDispensingEnhancementSchemaStatements() {
        const statements = [];
    ...
    getSprint59VitalsExtendedStatements() {
        return [
    ...
    getSprint60PatientExtendedSdohStatements() {
        return [
    ...
    getSprint61CdssOutcomeFeedbackStatements() {
        return [
    ...
    getSprint62ProactiveCareGapsStatements() {
        return [
    ...
    getSprint63AmbientAiStatements() {
        return [
    ...
    getSprint64PreChartingStatements() {
        return [
    ...
    getSprint65SmartInboxStatements() {
        return [
    ...
    getSprint67PediatricsModuleStatements() {
        return [
    ...
    getSprint68MentalHealthModuleStatements() {
        return [
    ...
    getSprint69MalariaModuleStatements() {
        return [
    ...
    getSprint70GeriatricsModuleStatements() {
        return [
    ...
    getSprint71NeurologyModuleStatements() {
        return [
    ...
    getSprint72PulmonologyModuleStatements() {
        return [
    ...
    getSprint73NephrologyModuleStatements() {
        return [
    ...
    getSprint74DermatologyModuleStatements() {
        return [
    ...
    getSprint75PalliativeCareModuleStatements() {
        return [
    ...
    getSprint76NutritionModuleStatements() {
        return [
    ...
    getSprint77IcuModuleStatements() {
        return [
    ...
    getSprint104TelemedicineVideoStatements() {
        return [
    ...
    getSprint106TelemedicineFixesStatements() {
        return [
            `ALTER TABLE telemedicine_consultations
    ...
    getSprint107TelemedicinePostvisitBridgeStatements() {
        return [
    ...
    getSprint109NotificationPersistenceStatements() {
        return [
    ...
    getSprint111SchemaCleanupStatements() {
        return [
            `ALTER TABLE IF EXISTS dialysis_records DROP COLUMN IF EXISTS urrpercent`,
        ];
    }
    getSprint111AiAuditHardeningStatements() {
        return [
            `CREATE EXTENSION IF NOT EXISTS pgcrypto`,
    ...
    getSprint103ModelRegistryStatements() {
        return [
            `DO $$
      BEGIN
        IF EXISTS (
    ...
    getSprint96RadiologyAiStatements() {
        return [
    ...
    getSprint97AlertDeliveryStatements() {
        return [
    ...
    getSprint98ModelMonitoringStatements() {
        return [
    ...
    getSprint99PatientAiStatements() {
        return [
    ...
    getSprint100TrialMatchingStatements() {
        return [
    ...
    getSprint101SupplyChainAiStatements() {
        return [
    ...
    getSprint89PredictiveRiskStatements() {
        return [
    ...
    getSprint90FederatedLearningStatements() {
        return [
    ...
    getSprint91HimisReportingStatements() {
        return [
    ...
    getSprint92FhirInboundStatements() {
        return [
    ...
    getSprint93MultilingualEducationStatements() {
        return [
    ...
    getSprint94OfflineSyncStatements() {
        return [
    ...
    getSprint95IotWearablesStatements() {
        return [
    ...
    getSprint88FormularyOptimizationStatements() {
        return [
    ...
    getSprint87SmartDefaultsStatements() {
        return [
    ...
    getSprint86SmartSchedulingStatements() {
        return [
    ...
    getSprint84AiExplainabilityStatements() {
        return [
    ...
    getSprint83AntibiogramStatements() {
        return [
    ...
    getSprint82PharmacogenomicsStatements() {
        return [
    ...
    getSprint81AutoCodingStatements() {
        return [
    ...
    getSprint80AdvancedHivPmtctPepfarStatements() {
        return [
    ...
    getSprint79NtdRegionalStatements() {
        return [
    ...
    getSprint111EntityCompletenessStatements() {
        return [
    ...
    getSprint78SdohModuleStatements() {
        return [
    ...
    getSprint112P0SafetyStatements() {
        return [
    ...
    getSprint112FeedbackPersistenceStatements() {
        return [
    ...
    getSprint113UiCompletenessStatements() {
        return [
    ...
    getSprint114ClinicalRagStatements() {
        return [
    ...
    getSprint115DenialPredictionStatements() {
        return [
    ...
    getSprint116RiskStratSelfLearningStatements() {
        return [
    ...
    getSprint117RegistrationAiStatements() {
        return [
    ...
    getSprint117RadiologyViewerStatements() {
        return [
