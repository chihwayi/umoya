...
Umoya is a production-grade, AI-first, multi-tenant electronic health record platform built for clinics, hospitals, and health ministries across Africa and the SADC region. It covers the full care continuum — from patient registration to discharge, billing, and post-visit follow-up — with a deeply integrated clinical AI layer and regional interoperability standards.
