...
import { FileText, X, Save, Calendar, Clock, User } from 'lucide-react';
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 rounded-3xl shadow-2xl border border-slate-200/50 w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-300">
          ...
          <div className="p-6 space-y-6">
            <div>
              ...
              <textarea value={chiefComplaint} onChange={(e) => setChiefComplaint(e.target.value)} rows={2} className="w-full border border-slate-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors resize-none" />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">Clinical Assessment</label>
              <textarea value={assessment} onChange={(e) => setAssessment(e.target.value)} rows={3} className="w-full border border-slate-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors resize-none" />
            </div>
            <div>
