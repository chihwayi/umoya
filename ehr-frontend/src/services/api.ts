...
export const ehrApi = {
  ...
  getCdpaControls: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/cdpa/controls', {
      headers: {
        'X-Tenant-ID': tenantSlug,
        Authorization: `Bearer ${token}`,
      },
  ...
  getCdpaSummary: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/cdpa/controls/summary', {
      headers: {
        'X-Tenant-ID': tenantSlug,
        Authorization: `Bearer ${token}`,
      },
  ...
  updateCdpaControl: async (token: string, tenantSlug: string, id: string, payload: any) => {
    const response = await ehrAxios.patch(`/cdpa/controls/${id}`, payload, {
      headers: {
        'X-Tenant-ID': tenantSlug,
        Authorization: `Bearer ${token}`,
      },
  ...
  setupMfa: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/auth/mfa/setup', {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  enableMfa: async (token: string, tenantSlug: string, totpCode: string) => {
    const response = await ehrAxios.post('/auth/mfa/enable', { totpCode }, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  verifyMfa: async (token: string, tenantSlug: string, totpCode: string) => {
    const response = await ehrAxios.post('/auth/mfa/verify', { totpCode }, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  complete2FALogin: async (tenantSlug: string, tempToken: string, code: string) => {
    const response = await ehrAxios.post('/auth/2fa/complete-login', { tempToken, code }, {
      headers: { 'X-Tenant-ID': tenantSlug },
    });
    return { data: response.data };
  },
  ...
  getStaffSessions: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/auth/sessions', {
      headers: {
        'X-Tenant-ID': tenantSlug,
        Authorization: `Bearer ${token}`,
      },
  ...
  revokeStaffSession: async (token: string, tenantSlug: string, jti: string, reason = 'user_revoked') => {
    const response = await ehrAxios.post(`/auth/sessions/${jti}/revoke`, { reason }, {
      headers: {
        'X-Tenant-ID': tenantSlug,
        Authorization: `Bearer ${token}`,
      },
  ...
  getPatientIntelligence: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/patients/${patientId}/intelligence`, {
      headers: {
        'X-Tenant-ID': tenantSlug,
        'Authorization': `Bearer ${token}`
      }
  ...
  // Training Platform
  listTrainingCourses: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/training/courses', {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getTrainingCourse: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/training/courses/${courseId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  searchTrainees: async (q: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/training/trainees?q=${encodeURIComponent(q)}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  registerTrainee: async (body: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/training/trainees', body, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  enrolTrainee: async (body: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/training/enrolments', body, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  submitTrainingAssessment: async (enrolmentId: string, body: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/training/enrolments/${enrolmentId}/assessments`, body, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  completeTrainingCourse: async (enrolmentId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/training/enrolments/${enrolmentId}/complete`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getCohortReport: async (courseId: string, cohortLabel: string, token: string, tenantSlug: string) => {
    const params = cohortLabel ? `?cohort=${encodeURIComponent(cohortLabel)}` : '';
    const response = await ehrAxios.get(`/training/courses/${courseId}/cohort-report${params}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getAlumniByFacility: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/training/alumni/by-facility', {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
...
// S221 — Notification Center (automated trigger configs, manual reminders, audit log)
export const notificationCenterApi = {
  getTriggers: async (tenantSlug: string, token: string) => {
  ...
  getLog: async (tenantSlug: string, token: string, params?: { limit?: number }) => {
...
export const uhcApi = {
  computeIndicators: async (tenantSlug: string, token: string, data: { year: number; quarter?: number }) => {
    const response = await ehrAxios.post('/analytics/uhc/compute', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getSnapshots: async (tenantSlug: string, token: string, year?: number) => {
    const response = await ehrAxios.get('/analytics/uhc/snapshots', {
      params: year != null ? { year } : {},
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getLatestSnapshot: async (tenantSlug: string, token: string) => {
    const response = await ehrAxios.get('/analytics/uhc/snapshots/latest', {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  getTargets: async (tenantSlug: string, token: string) => {
    const response = await ehrAxios.get('/analytics/uhc/targets', {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  updateTarget: async (
    ...
    token: string,
    code: string,
    data: { targetValue: number; nationalTarget?: number },
  ) => {
    const response = await ehrAxios.patch(`/analytics/uhc/targets/${encodeURIComponent(code)}`, data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  pushToDhis2: async (tenantSlug: string, token: string, snapshotId: string) => {
    const response = await ehrAxios.post(`/analytics/uhc/snapshots/${snapshotId}/push-dhis2`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
...
export const cdssApi = {
  ...
  getNutritionScreenings: async (patientId: string, tenantSubdomain: string) => {
    ...
    return ehrAxios.get(`/nutrition/patient/${patientId}/screening`, {
      headers: { Authorization: `Bearer ${token}`, 'X-Tenant-ID': tenantSubdomain },
    });
  },
...
export const cervicalCancerApi = {
  recordScreening: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/cervical-cancer/patient/${patientId}/screenings`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getScreenings: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cervical-cancer/patient/${patientId}/screenings`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getLatestScreening: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cervical-cancer/patient/${patientId}/screenings/latest`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordTreatment: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/cervical-cancer/patient/${patientId}/treatments`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getTreatments: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cervical-cancer/patient/${patientId}/treatments`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
...
export const familyPlanningApi = {
  enroll: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/family-planning/patient/${patientId}/enroll`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getEnrollments: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/family-planning/patient/${patientId}/enrollments`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getActiveEnrollment: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/family-planning/patient/${patientId}/active`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  updateEnrollment: async (id: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.patch(`/family-planning/enrollments/${id}`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordFollowup: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/family-planning/patient/${patientId}/followups`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getFollowups: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/family-planning/patient/${patientId}/followups`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
...
export const hypertensionApi = {
  enroll: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/hypertension/patient/${patientId}/register`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getRegisterEntry: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/hypertension/patient/${patientId}/register`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  updateRegisterEntry: async (id: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.patch(`/hypertension/register/${id}`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordBp: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/hypertension/patient/${patientId}/bp`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getBpHistory: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/hypertension/patient/${patientId}/bp`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordReview: async (patientId: string, dto: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/hypertension/patient/${patientId}/reviews`, dto, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getReviews: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/hypertension/patient/${patientId}/reviews`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getStepTherapy: async (data: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/hypertension/cdss/step-therapy', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getCvdRisk: async (data: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/hypertension/cdss/cvd-risk', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
...
export const oneHealthApi = {
  ...
  getExposures: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/one-health/patient/${patientId}/exposures`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  createReport: async (patientId: string, data: Record<string, any>, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/one-health/patient/${patientId}/reports`, data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  submitReport: async (reportId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/one-health/reports/${reportId}/submit`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getReports: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/one-health/patient/${patientId}/reports`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  startRabiesPep: async (patientId: string, data: Record<string, any>, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/one-health/patient/${patientId}/rabies-pep`, data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getRabiesPepStatus: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/one-health/patient/${patientId}/rabies-pep`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  assessZoonotic: async (data: Record<string, any>, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/one-health/cdss/zoonotic-assess', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  matchPACTRTrials: async (subdomain: string, patientId: string, token: string, condition?: string) => {
    const response = await ehrAxios.post('/trials/match/pactr', { subdomain, patientId, condition }, {
      headers: { 'X-Tenant-ID': subdomain, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
...
export const culturalApi = {
  upsertSdoh: async (data: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/cultural/sdoh', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getSdoh: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cultural/sdoh/${patientId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getSdohRisk: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cultural/sdoh/${patientId}/risk`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordFamilyConsent: async (data: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/cultural/family-consent', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getFamilyConsents: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cultural/family-consent/${patientId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  recordWellbeing: async (data: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/cultural/wellbeing', data, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getWellbeingHistory: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cultural/wellbeing/${patientId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
  getCulturalSummary: async (patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/cultural/summary/${patientId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return response.data;
  },
...
export const healthEducationApi = {
  // Course management (staff authoring)
  listCourses: async (token: string, tenantSlug: string) => {
    const response = await ehrAxios.get('/health-education/courses', {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  getCourse: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/health-education/courses/${courseId}`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  createCourse: async (payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post('/health-education/courses', payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  updateCourse: async (courseId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.patch(`/health-education/courses/${courseId}`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  publishCourse: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/courses/${courseId}/publish`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  unpublishCourse: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/courses/${courseId}/unpublish`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  ...
  // Modules
  getModules: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/health-education/courses/${courseId}/modules`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  addModule: async (courseId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/courses/${courseId}/modules`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  reorderModule: async (moduleId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/modules/${moduleId}/reorder`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  ...
  // Lessons
  addLesson: async (moduleId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/modules/${moduleId}/lessons`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  upsertTranslation: async (lessonId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/lessons/${lessonId}/translations`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  ...
  // Quiz
  createQuiz: async (lessonId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/lessons/${lessonId}/quiz`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  addQuizQuestion: async (quizId: string, payload: any, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/quizzes/${quizId}/questions`, payload, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
  ...
  assignCourseToPatient: async (courseId: string, patientId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/courses/${courseId}/assign/${patientId}`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  assignCourseToAll: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.post(`/health-education/courses/${courseId}/assign-all`, {}, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },

  getCourseProgress: async (courseId: string, token: string, tenantSlug: string) => {
    const response = await ehrAxios.get(`/health-education/courses/${courseId}/progress`, {
      headers: { 'X-Tenant-ID': tenantSlug, Authorization: `Bearer ${token}` },
    });
    return { data: response.data };
  },
