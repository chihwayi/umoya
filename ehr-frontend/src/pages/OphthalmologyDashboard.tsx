    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        <div className="flex flex-wrap gap-3 items-center justify-between bg-white border border-slate-200 rounded-2xl shadow-sm p-4">
          <div>
            <p className="text-sm font-medium text-slate-700">Return to doctor dashboard</p>
            <p className="text-xs text-slate-500">Hop back to your main clinician view whenever you need.</p>
          </div>
          <button
            onClick={() => navigate(`/ehr/${tenantSlug}/doctor`)}
