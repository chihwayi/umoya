  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#080E1A] px-4 text-center">
      <div className="max-w-md">
        <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl border border-[#3B9EFF]/30 bg-[#3B9EFF]/10">
          <svg className="h-8 w-8 text-[#3B9EFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          onClick={() => navigate(-1)}
          className="mt-6 rounded-full bg-gradient-to-r from-[#0AA98A] to-[#00A87A] px-6 py-2.5 text-sm font-bold text-[#051119] hover:from-[#00D9A3]"
        >
          Go back
        </button>
      </div>
