      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-4rem)] max-w-5xl items-center gap-8 lg:grid-cols-[1.02fr_0.98fr]">
        <section className="rounded-[36px] border border-white/10 bg-[linear-gradient(180deg,rgba(14,24,41,0.94),rgba(8,14,26,0.98))] p-8 shadow-[0_35px_120px_rgba(0,0,0,0.45)]">
          ...
          <p className="mt-6 max-w-xl text-sm leading-7 text-[#AFC1DF]">
            ...
            design language as the rest of Umoya.
          </p>
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                type="email"
                className="w-full rounded-2xl border border-[#253A58] bg-[#091320] px-4 py-3 text-sm text-white outline-none transition placeholder:text-[#4A6080] focus:border-[#3B9EFF] focus:ring-2 focus:ring-[#3B9EFF]/20"
            ...
            <button
              onClick={login}
              disabled={loading}
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#0AA98A] px-6 py-3.5 text-sm font-semibold text-[#040A10] shadow-[0_20px_80px_rgba(10,169,138,0.22)] transition hover:bg-[#12BFAB] disabled:opacity-50"
            >
