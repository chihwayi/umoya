...
const BUNDLE_ID = 'sprint55_post_visit_citation_quality_v2';
  ...
  try {
    ...
    await tenantClient.query(
      ...
      [
        BUNDLE_ID,
        BUNDLE_VERSION,
        'scripts/provision-sprint55-post-visit-citation-quality-v2.ts',
        'Sprint A4 citation quality v2 columns and indexes',
      ],
    );
