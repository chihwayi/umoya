...
const BUNDLE_ID = 'sprint54_post_visit_diarization_review';
  ...
  try {
    ...
    await tenantClient.query(
      ...
      [
        BUNDLE_ID,
        BUNDLE_VERSION,
        'scripts/provision-sprint54-post-visit-diarization-review.ts',
        'Sprint A3 diarization review columns and indexes',
      ],
    );
