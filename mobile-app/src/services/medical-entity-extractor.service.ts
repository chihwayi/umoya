/**
 * Medical Entity Extractor Service
...
class MedicalEntityExtractor {
  ...
  private extractSymptoms(text: string): string[] {
    ...
    // Extract symptoms mentioned after "complains of" or "symptoms include"
  ...
  private extractChiefComplaint(text: string): string | undefined {
    ...
    // If no explicit chief complaint, use first sentence
